...
class ClassmatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classmate" do
    assert_difference('Classmate.count') do
      post classmates_url, params: { classmate: { age: @classmate.age, email: @classmate.email, first_name: @classmate.first_name, last_name: @classmate.last_name } }
    end
  ...
  test "should update classmate" do
    patch classmate_url(@classmate), params: { classmate: { age: @classmate.age, email: @classmate.email, first_name: @classmate.first_name, last_name: @classmate.last_name } }
